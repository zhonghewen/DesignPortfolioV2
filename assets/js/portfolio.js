...
const PROJECTS = [
  { id:0, title:"AI-Enhanced Seller Triage @Amazon",
    ...
    desc:"Designed AI-guided interactions that walk Amazon sellers through structured issue triage, driving self-service automation and $8.7M in annual savings.",
    high:"Validated design feasibility through an AI proof of concept.",
  ...
  { id:1, title:"Evolving Seller Support into Conversational AI @Amazon",
    tags:"#Inline interaction patterns",
    role:"Sole UX Designer",
    desc:"Defined what Amazon's legacy seller support looks like as a conversational assistant — and set the quality bar that made each phase shippable.",
    high:"Established inline interaction patterns that fit LLM's probabilistic nature.",
  ...
  { id:2, title:"Unified AI Workspace for Internal Associates @Amazon",
    tags:"#Complex workflow  #Working AI Prototyping",
    role:"Sole UX Designer, UX researcher",
    desc:"Consolidated 5+ disconnected AI widgets into a unified workspace for internal associates handling complex seller cases — validating the direction through working AI prototypes.",
    high:"Used rapid AI prototyping to clarify ambiguous requirements and shape roadmap strategy.",
